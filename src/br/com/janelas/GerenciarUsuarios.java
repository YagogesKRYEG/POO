...
public class GerenciarUsuarios extends JFrame{
	...
	public static void main(String[] args) {
		...
		//Agora podemos criar nossos componentes e posiciona-los
		//da maneira que quisermos
		JButton btnCadastrar = new JButton("Cadastrar");
		/*
		 * O fato de você ter configurado o gerenciador de layout
		 * como null(Absolute) lhe 
		 * x -> posição horinzontal 
		 * y -> posição vertical
		 * width ->largura
		 * height--> altura
		 */
		...
		//que nese caso é o btnCadastrar 
		...
		txtResultado.setBounds(120,150,330,70);
		...
		btnCadastrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				us.login = txtLogin.getText();//pegar o que foi escritona caixa do login 
